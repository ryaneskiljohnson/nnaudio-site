/**
 * @fileoverview Interactive product page hydrated from server-fetched catalog data.
 * @module app/product/[slug]/ProductPageClient
...
export default function ProductPageClient({
  ...
  useEffect(() => {
    if (slug) {
      fetchProduct({ silent: Boolean(initialProduct) && initialProduct.slug === slug });
    }
  }, [slug]);
