...
const FILENAME_TO_SLUG: Record<string, string> = {
  ...
  "MIDI Nerds FREE Pack - New Nation.zip": "midi-nerds-free-midi",
  ...
  "Ultimate MIDI Collection 4 - New Nation.zip": "mai-tai-midi",
  "Ultimate MIDI Collection 5 - New Nation.zip": "fruit-salad-midi",
  "Ultimate MIDI Collection 6 - New Nation.zip": "umc6-midi",
