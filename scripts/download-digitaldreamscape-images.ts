...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/DD-Samplers.webp',
    fileName: 'digitaldreamscape-features-samplers.webp',
    featureTitle: '4 Rompler Engines'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/DD-FX.webp',
    fileName: 'digitaldreamscape-features-fx.webp',
    featureTitle: 'Built-In FX Modules'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/DD-Instruments.gif',
    fileName: 'digitaldreamscape-features-instruments.gif',
    featureTitle: '315 Sampled Instruments'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/DD-Presets.webp',
    fileName: 'digitaldreamscape-features-presets.webp',
    featureTitle: '500+ Factory Presets'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/DD-Interface.webp',
    fileName: 'digitaldreamscape-features-interface.webp',
    featureTitle: 'Intuitive Interface'
  }
];
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading DigitalDreamscape Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2023/05/DD.webp';
  const guiFileName = 'digitaldreamscape-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated DigitalDreamscape with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated DigitalDreamscape features with images!');
    }
  }
