...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/TetradKeysScreenshot.webp',
    fileName: 'tetrad-features-keys.webp',
    featureTitle: 'Tetrad: Keys'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/TetradGuitarsScreenshot.webp',
    fileName: 'tetrad-features-guitars.webp',
    featureTitle: 'Tetrad: Guitars'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/TetradWindsScreenshot.webp',
    fileName: 'tetrad-features-winds.webp',
    featureTitle: 'Tetrad: Winds'
  }
];
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Tetrad Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2024/01/tetradseries-GUI.png.webp';
  const guiFileName = 'tetrad-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Tetrad with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Tetrad features with images!');
    }
  }
