...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Mesosphere-Samplers.webp',
    fileName: 'mesosphere-features-samplers.webp',
    featureTitle: 'Dual Sampler Engines'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Mesosphere-FX.webp',
    fileName: 'mesosphere-features-fx.webp',
    featureTitle: 'Built-In FX Suite'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Mesosphere-GUI.webp',
    fileName: 'mesosphere-features-gui.webp',
    featureTitle: 'Intuitive GUI Design'
  }
];
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Mesosphere Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2024/01/Mesosphere-GUI.webp';
  const guiFileName = 'mesosphere-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Mesosphere with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Mesosphere features with images!');
    }
  }
