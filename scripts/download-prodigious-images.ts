...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Prodigious-Samples.gif',
    fileName: 'prodigious-features-samples.gif',
    featureTitle: '32 Sampled Instruments'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Prodigious-64Voices.webp',
    fileName: 'prodigious-features-64voices.webp',
    featureTitle: '64 Playable Voices'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Prodigious-FX.webp',
    fileName: 'prodigious-features-fx.webp',
    featureTitle: 'Built-In Effects Suite'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Prodigious-GUI.webp',
    fileName: 'prodigious-features-gui.webp',
    featureTitle: 'Easy-To-Use Interface'
  }
];
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Prodigious Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2024/01/Prodigious-GUI.webp';
  const guiFileName = 'prodigious-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Prodigious with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Prodigious features with images!');
    }
  }
