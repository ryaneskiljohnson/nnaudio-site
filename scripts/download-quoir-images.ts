...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Quoir-VocalEngines.webp',
    fileName: 'quoir-features-vocalengines.webp',
    featureTitle: '4 Vocal Engines'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Quoir-FX.webp',
    fileName: 'quoir-features-fx.webp',
    featureTitle: 'Built-In Effect Modules'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Quoir-GUI.webp',
    fileName: 'quoir-features-gui.webp',
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Quoir Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2023/05/Quoir-UI.webp';
  const guiFileName = 'quoir-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Quoir with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Quoir features with images!');
    }
  }
