...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Apache-Flutes.webp',
    fileName: 'apache-features-flutes.webp',
    featureTitle: '4 Adjustable Flutes'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Apache-Effects.webp',
    fileName: 'apache-features-effects.webp',
    featureTitle: 'Effects & Artifact Modules'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Apache-GUI.webp',
    fileName: 'apache-features-gui.webp',
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Apache Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2024/01/Apache-GUI.webp';
  const guiFileName = 'apache-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Apache with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Apache features with images!');
    }
  }
