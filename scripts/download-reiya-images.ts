...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Reiya-Engines.webp',
    fileName: 'reiya-features-engines.webp',
    featureTitle: '4 Sampler Engines'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Reiya-Samples.webp',
    fileName: 'reiya-features-samples.webp',
    featureTitle: 'Nearly 200 Multi-Sampled Instruments'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Reiya-Effects.webp',
    fileName: 'reiya-features-effects.webp',
    featureTitle: 'Built-In Effects Suite'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2023/05/Reiya_Art_GUI.webp',
    fileName: 'reiya-features-gui.webp',
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Reiya Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2023/05/Reiya_Art_GUI.webp';
  const guiFileName = 'reiya-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Reiya with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Reiya features with images!');
    }
  }
