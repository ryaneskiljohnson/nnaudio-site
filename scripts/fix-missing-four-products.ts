...
const PRODUCTS_TO_FIX = [
  { id: 'cb7347ad-4fc0-4745-b4fd-110aea318b5f', slug: 'percgadget-drum-machine', name: 'PercGadget' },
  { id: '05472103-835a-4d3f-82e2-e9d8a537dea2', slug: 'crystalball-effects', name: 'CrystalBall' },
  { id: '32c90731-d973-4f23-ba51-d353e3d99ba7', slug: 'time-zones-delay', name: 'Time Zones' },
  { id: 'f3dc4888-fe08-4b6f-91b4-55d18d66655b', slug: 'weaknd-synth', name: 'Weaknd' },
];
...
async function fixMissingFourProducts() {
  console.log('=== Fixing Missing 4 Products ===\n');
...
fixMissingFourProducts().catch(console.error);
