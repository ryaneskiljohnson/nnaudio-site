...
const SAMPLE_REVIEWS = [
  ...
  },
  {
    ...
    review_text: 'This is a great tool/VST to have, especially if you\'re looking for a wide range of manipulable options. I\'m still learning and new to it, but it has some great, useful sounds, and lots of ways to modify them. So far, I give this plug-in a 5/5!',
...
async function populateReviews() {
  console.log('=== Populating Mesosphere Reviews ===\n');
  ...
  console.log('\n✅ Successfully populated Mesosphere reviews!');
}
