...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Subflux-Samplers.webp',
    fileName: 'subflux-features-samplers.webp',
    featureTitle: '2 Bass Samplers'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Subflux-FX.webp',
    fileName: 'subflux-features-fx.webp',
    featureTitle: 'Built-In Effect Modules'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Subflux-GUI.webp',
    fileName: 'subflux-features-gui.webp',
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading SubFlux Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2024/01/Subflux-GUI.webp';
  const guiFileName = 'subflux-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated SubFlux with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated SubFlux features with images!');
    }
  }
