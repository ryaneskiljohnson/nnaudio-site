...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Noker-Engines.webp',
    fileName: 'noker-features-engines.webp',
    featureTitle: '18 Adjustable Engines'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Noker-FX.webp',
    fileName: 'noker-features-fx.webp',
    featureTitle: 'Big Effects with 2 Knobs'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Noker-SoundLayout.webp',
    fileName: 'noker-features-soundlayout.webp',
    featureTitle: 'Intuitive Sound Layout'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Noker-GUI.webp',
    fileName: 'noker-features-gui.webp',
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Noker Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2023/05/Noker-UI.webp';
  const guiFileName = 'noker-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Noker with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Noker features with images!');
    }
  }
