...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Curves-EQs.webp',
    fileName: 'curves-eq-features-eqs.webp',
    featureTitle: 'Four EQs with 16 Bands'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Curves-Visual.webp',
    fileName: 'curves-eq-features-visual.webp',
    featureTitle: 'Visualize in Real-Time'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Curves-EasyTouse.webp',
    fileName: 'curves-eq-features-easytouse.webp',
    featureTitle: 'Streamlined Workflow'
  }
];
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Curves EQ Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2023/05/curvesGUI.webp';
  const guiFileName = 'curves-eq-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Curves EQ with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Curves EQ features with images!');
    }
  }
