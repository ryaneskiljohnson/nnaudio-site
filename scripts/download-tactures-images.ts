...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Tactures-Sampler.webp',
    fileName: 'tactures-features-sampler.webp',
    featureTitle: 'Unique Sampler Engine'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Tactures-FX.webp',
    fileName: 'tactures-features-fx.webp',
    featureTitle: 'Built-In Effect Modules'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Tactures-GUI.webp',
    fileName: 'tactures-features-gui.webp',
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Tactures Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2024/01/Tactures-GUI.webp';
  const guiFileName = 'tactures-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Tactures with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Tactures features with images!');
    }
  }
