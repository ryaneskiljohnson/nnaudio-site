...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Natura-Engines.webp',
    fileName: 'natura-features-engines.webp',
    featureTitle: '4 Analog Engines'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Natura-FX.webp',
    fileName: 'natura-features-fx.webp',
    featureTitle: 'Built-In FX Suite'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Natura-Samples.webp',
    fileName: 'natura-features-samples.webp',
    featureTitle: '66 Analog Instruments'
  }
];
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Natura Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2023/05/Natura-UI.webp';
  const guiFileName = 'natura-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Natura with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Natura features with images!');
    }
  }
