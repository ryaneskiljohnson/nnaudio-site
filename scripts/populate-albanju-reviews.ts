...
const SAMPLE_REVIEWS = [
  {
    rating: 4,
    title: 'Nice and easy to use Instrument',
    review_text: 'Nice and easy to use Instrument',
    customer_name: 'Lasse F.',
...
async function populateReviews() {
  console.log('=== Populating Albanju Reviews ===\n');
  ...
  console.log('\n✅ Successfully populated Albanju reviews!');
}
