...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Mandolele-Lutes.webp',
    fileName: 'mandolele-features-lutes.webp',
    featureTitle: '4 Multi-Sampled Lutes'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Mandolele-FX.webp',
    fileName: 'mandolele-features-fx.webp',
    featureTitle: 'Built-In FX Suite'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Mandolele-GUI.webp',
    fileName: 'mandolele-features-gui.webp',
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Mandolele Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2024/01/Mandolele-GUI.webp';
  const guiFileName = 'mandolele-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Mandolele with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Mandolele features with images!');
    }
  }
