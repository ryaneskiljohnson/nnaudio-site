...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Rompl-Samplers.webp',
    fileName: 'rompl-features-samplers.webp',
    featureTitle: '4 Sampler Engines'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2023/09/RomplSamplersUI.webp',
    fileName: 'rompl-features-sampler-ui.webp',
    featureTitle: '200 Sampled Instruments'
  }
];
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Rompl Workstation Images ===\n');
  ...
  // Download GUI image (use the samplers UI as the main GUI)
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2023/09/RomplSamplersUI.webp';
  const guiFileName = 'rompl-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Rompl Workstation with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Rompl Workstation features with images!');
    }
  }
