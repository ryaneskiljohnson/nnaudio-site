...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Albanju-Banjos.webp',
    fileName: 'albanju-features-banjos.webp',
    featureTitle: '4 Adjustable Banjos'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Albanju-Effects.webp',
    fileName: 'albanju-features-effects.webp',
    featureTitle: 'Effects & Artifact Modules'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Albanju-GUI.webp',
    fileName: 'albanju-features-gui.webp',
    featureTitle: 'Easy Interface & Browser'
  }
];
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Albanju Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2023/05/Albanju-UI.webp';
  const guiFileName = 'albanju-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Albanju with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Albanju features with images!');
    }
  }
