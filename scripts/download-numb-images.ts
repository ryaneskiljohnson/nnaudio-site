...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Numb-Samples.webp',
    fileName: 'numb-features-samples.webp',
    featureTitle: '14 Multi-Sampled Guitars'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Numb-Engines.webp',
    fileName: 'numb-features-engines.webp',
    featureTitle: '4 Guitar Engines'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Numb-FX.webp',
    fileName: 'numb-features-fx.webp',
    featureTitle: 'Built-In Effects Suite'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Numb-GUI.webp',
    fileName: 'numb-features-gui.webp',
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Numb Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2024/01/Numb-GUI.webp';
  const guiFileName = 'numb-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Numb with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Numb features with images!');
    }
  }
