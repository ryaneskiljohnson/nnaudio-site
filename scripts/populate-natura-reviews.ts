...
const SAMPLE_REVIEWS = [
  {
    rating: 5,
    title: 'I like this instrument',
    review_text: 'I like this instrument it\'s good for the price so I am pleased with it.',
...
async function populateReviews() {
  console.log('=== Populating Natura Reviews ===\n');
  ...
  console.log('\n✅ Successfully populated Natura reviews!');
}
