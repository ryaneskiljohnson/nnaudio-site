...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Obscura-Samples.gif',
    fileName: 'obscura-features-samples.gif',
    featureTitle: '32 Sampled Instruments'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Obscura-16Voices.webp',
    fileName: 'obscura-features-16voices.webp',
    featureTitle: '16 Playable Voices'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Obscura-FX.webp',
    fileName: 'obscura-features-fx.webp',
    featureTitle: 'Built-In Effects Modules'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Obscura-GUI.webp',
    fileName: 'obscura-features-gui.webp',
    featureTitle: 'Intuitive Interface Layout'
  }
];
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Obscura Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2024/01/Obscura-GUI.webp';
  const guiFileName = 'obscura-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Obscura with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Obscura features with images!');
    }
  }
