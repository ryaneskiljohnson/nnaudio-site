...
const FEATURE_IMAGES = [
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Blaque-Samplers.webp',
    fileName: 'blaque-features-samplers.webp',
    featureTitle: '4 Guitar Modules'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Blaque-Effects.webp',
    fileName: 'blaque-features-effects.webp',
    featureTitle: 'Effects & Artifact Modules'
  },
  {
    url: 'https://nnaud.io/wp-content/uploads/2024/01/Blaque-GUI.webp',
    fileName: 'blaque-features-gui.webp',
...
async function downloadAndUploadImages() {
  console.log('=== Downloading and Uploading Blaque Images ===\n');
  ...
  const guiImageUrl = 'https://nnaud.io/wp-content/uploads/2024/01/Blaque-GUI.webp';
  const guiFileName = 'blaque-gui.webp';
  ...
  if (!downloaded) {
    ...
    if (!supabaseUrl) {
      ...
      if (updateError) {
        ...
        console.log('✅ Successfully updated Blaque with GUI image');
      }
    }
  }
  ...
  if (updatedFeatures.some((f: any) => f.image_url)) {
    ...
    if (updateError) {
      ...
      console.log('✅ Successfully updated Blaque features with images!');
    }
  }
