...
describe("hero source contracts", () => {
  ...
  it("keys bodies from the camera so the visible side stays lit", () => {
    ...
    expect(skybox).toContain("starLayer");
    expect(skybox).toContain("unityGradientNoise");
    expect(skybox).toContain("sampleNebulaGradient");
    expect(skybox).toContain("vec3 magenta");
    expect(skybox).toContain("vec3 cyan");
    expect(skybox).toContain("neonPunch");
    expect(skybox).toContain("uBodyColor");
    expect(skybox).toContain("uSkyPan");
    expect(skybox).toContain("uSkyScale");
    expect(skybox).toContain("hero-nebula");
    expect(skybox).toContain("hero-stars");
    expect(skybox).toContain("HERO_STAR_COUNT");
    expect(skybox).toContain("saturate(uStarCount / 2500.0)");
    expect(skybox).not.toContain("clamp(uStarCount / 900.0, 0.08, 0.28)");
